...
Invoice = Struct.new(:client) do
  ...
  #TODO this is what you're testing ⬇️
  #allow nil becomes a special case of default
  #if allow nil is true then the default is nil
  #default of default is to raise the error
  #if the client is nil then return something
  delegate :street, :city, :name, to: :client, prefix: :optional, default: nil
end
